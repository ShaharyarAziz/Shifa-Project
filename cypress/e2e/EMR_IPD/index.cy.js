...
describe("Main Login", () => {
  ...
  it("Login", () => {
    ...
    cy.contains("G-1").click({ force: true });
    //lOGIN Password
    ...
    cy.wait(2000);
    cy.get(
      '[data-row-key="19494765"] > :nth-child(4) > .ant-row > a > .patient-name-text'
    ).click();
    //Nurses
    ...
    //other Text Field
    cy.get("#habits_text").type("For testing Purpose");
    ...
    cy.get(
      ".ant-col-19 > .ant-radio-wrapper > .ant-radio > .ant-radio-input"
    ).click();
