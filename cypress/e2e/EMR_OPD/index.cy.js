...
describe("Main Login", () => {
  ...
  it.only("login", () => {
    ...
    cy.get('[data-row-key="3"] > :nth-child(5) > .patient-name > a > .patient-name-text').click()
    cy.get('.ant-menu-item-selected > .ant-menu-item-icon')    
  ...
  //   cy.get(
  //     ":nth-child(12) > :nth-child(1) > .ant-col-11 > :nth-child(1) > :nth-child(1) > .ant-col-2 > .anticon > svg"
  //   ).click();
  ...
  //   // // Add Button
  //   cy.get(
  //     ":nth-child(7) > :nth-child(1) > .ant-popover > .ant-popover-content > .ant-popover-inner > .ant-popover-inner-content > :nth-child(2) > .ant-col > .popover-btn > :nth-child(2) > .ant-btn > span"
  //   ).click();
